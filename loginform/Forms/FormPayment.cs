...
namespace Laptop.NewFolder1
{
    public partial class FormPayment : Form
    {
        ...
        SqlCommand command;
        string str = @"Data Source=DESKTOP-GBCSH04\SQLEXPRESS;Initial Catalog=QLlaptop;Integrated Security=True";
        ...
        public void EditTablesFormPayment()
        {
			...
			dgvInvoiceInformation.Columns[4].HeaderText = "Username";
